<template>
  <div>
    ...
    >
      ...
      <el-table-column label="评价" prop="comment" show-overflow-tooltip></el-table-column>
    ...
    <div style="display:flex;justify-content:center;">
          <router-link :to="'/pcomment/'+user+'/'+page">
...
export default {
  ...
  methods: {
    ...
    handleDelete(index, row) {
      this.axios.post(this.HOST+"/pcomment/user/"+this.user+"/page/"+this.page,{
              row: row
        }).then((response)=>{
            this.getDataO()
        });
    ...
    getDataO(){
      this.axios
      .get(this.HOST+"/pcomment/user/"+this.user+"/page/"+this.page)
      .then(res => {
